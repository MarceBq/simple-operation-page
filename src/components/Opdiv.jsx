...
export default function Opdiv() {
    ...
    useEffect(() => {
        const div = () => {
            const opDiv = (parseInt(num1 || 0) || parseFloat(num1 || 0)) / (parseInt(num2 || 0) || parseFloat(num2 || 0))
            setResult(opDiv);
        };
        div();
    }, [num1, num2]);
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center">
            <h1 className="py-2 text-center" style={{ fontSize: '1.8rem' }}>Bienvenido al calculador de divisiones</h1>
            ...
            <p className="py-2 text-center">La división de ambos números es: {result}</p>
            <Link to="/">
